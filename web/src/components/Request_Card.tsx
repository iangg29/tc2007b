...
const Request_Card = () => {
    return (
        <div className="w-full max-w-sm">
            ...
            <img className="py-4 rounded-xl"
            src="https://infolibros.org/wp-content/uploads/2021/06/Libros-de-Artes-Visuales.jpg?ezimgfmt=ng%3Awebp%2Fngcb33%2Frs%3Adevice%2Frscb33-1" alt="art" />
